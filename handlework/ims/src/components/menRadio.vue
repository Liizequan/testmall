    ...
    <div class='menRadio'>
        <el-popover placement="bottom-start" trigger="click" v-model="charPopo">
            <div>
                ...
                <el-menu>
                    <el-radio-group v-model="theRadio">
                        <el-submenu v-if="searchRes.length" index="999">
                            ...
                            <el-menu-item>
                                <el-radio v-for="item in searchRes" :key="item.user_id" :label="item.user_id">
                                    {{item.name}}
                                </el-radio>
                            </el-menu-item>
                        </el-submenu>
                        <el-submenu v-for="(item,index) in excuters" :key="index" :index="index+''">
                            ...
                            <el-menu-item>
                                <el-radio v-for="it in item.user" :key="it.user_id" :label="it.user_id">{{it.name}}
                                </el-radio>
                            </el-menu-item>
                        </el-submenu>
                    </el-radio-group>
