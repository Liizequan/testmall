<template>
    <div class='myDocu contain'>
        <div style="margin-bottom:20px;text-align: left;">
            ...
            <el-button @click="getList" :style="one?'background:#409EFF;color:#fff;':''">我的文档库</el-button>
            <el-button @click="getmyview" :style="!one?'background:#409EFF;color:#fff;':''">我关注的文档</el-button>
        </div>
            ...
            <el-table-column label="操作">
                <template slot-scope="scope">
                    <div>
                        ...
                        <el-link :underline='false' type='primary' class='ml20' @click="del(scope.row.document_id)">删除
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                this.one = true
                this.$http.get('document/mydocumentList').then(res => {
                    this.list = res.msg
                })
            }
        },
