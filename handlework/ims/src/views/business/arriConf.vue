<template>
  <div class="arriConf contain">
    <div v-if="this.$route.path == '/arriConf'">
      <div class="topBtns">
        <div class="leftBtns">
      ...
      <el-table :data="tableData" @selection-change="selChan" stripe :header-cell-style="$store.state.headStyle">
        ...
        <el-table-column label="客户名称" prop="customer" width="90"></el-table-column>
        <el-table-column label="订单/合同编号" prop="order_no" width="140"></el-table-column>
        ...
        <el-table-column label="审核状态" prop="is_status" width="80"></el-table-column>
        <el-table-column label="操作" width="120">
          <template slot-scope="scope">
            <div style="display:flex;">
              <el-link type="primary" @click="toDetail(scope.row.id)">详情<i class='el-icon-arrow-right'></i></el-link>
              <el-link v-if="all==1" type="primary" @click="del(scope.row.id)" class="delBtn delRed">删除<i class='el-icon-delete'></i>
              </el-link>
            </div>
          </template>
        </el-table-column>
