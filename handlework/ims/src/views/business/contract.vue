<template>
  <div class="contract contain">
    <div v-if="this.$route.path == '/contract'">
      <div class="topBtns">
        <div class="leftBtns">
      ...
      :header-cell-style="$store.state.headStyle">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-link type="primary" @click="del(scope.row.id)" style="margin-left:10px;" v-if="all==1">删除<i
...
<script>
  export default {
    ...
    methods: {
      ...
      getList(page) {
        this.$http.get('contract/index', { token: localStorage.getItem('token'), page: page || 1 }).then(res => {
          // this.tableData = res
          // this.tempData = res.slice(0, 10)
          this.tempData = res
        })
