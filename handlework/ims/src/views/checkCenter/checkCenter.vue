<template>
  <div class="checkCenter contain">
    <div v-if="this.$route.path == '/checkCenter'">
      ...
      :header-cell-style="$store.state.headStyle">
        ...
        <el-table-column label="申请人" prop="user_id" width="90px"></el-table-column>
        <el-table-column label="申请时间" prop="create_time" sortable></el-table-column>
        <el-table-column label="审批人" prop="approval" width="90px"></el-table-column>
