<template>
    <div class="contain">
        <div class="staff" v-if="this.$route.path =='/inAchieve'">
            <!-- 头部 -->
            <div class="header">
                <!-- 全部 -->
                <header class="between" v-if="tabbar==0">
                    ...
                    <div class="right between font14-nobold-9 mb10">
            ...
            <div class="table">
                ...
                <div class="is-table">
                    <el-table
                        ...
                        <el-table-column prop="score" label="考核状态">
                        </el-table-column>
