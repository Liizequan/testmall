<template>
    <div class="contain">
        <!-- 我是工作汇报 -->
        <div class="report" v-if="$route.path == '/inReport'">
                    ...
                    <el-table-column label="操作">
                        <template slot-scope="scope">
                            <div>
                                ...
                                <el-link type="primary" style="margin-right:20px;" @click="goNoticeDetail(scope.row)">详情<i class="el-icon-arrow-right"></i></el-link>
