    ...
    <div class='shareDocu contain'>
        ...
        :header-cell-style="$store.state.headStyle">
            ...
            <el-table-column label="操作">
                <template slot-scope="scope">
                    <div class="">
                        <el-link :underline='false' type='primary' @click="check(scope.row)">审核 <i class='el-icon-search'></i></el-link>
<!-- 
                        <menRadio :excuters="excuters" @theRes="execuRes">
                            ...
                            <template slot="main">
                                <el-link :underline='false' type='primary' style="margin-left:30px;">分享</el-link>
                            </template>
                        </menRadio> -->
                        <el-link :underline='false' type='primary' class='ml20' @click="download(scope.row)">下载 <i class='el-icon-download'></i>
                        </el-link>
                    </div>
                </template>
            </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                this.$http.get('document/sharedocumentlist').then(res => {
                    this.list = res.msg
                })
            },
            download(row) {
