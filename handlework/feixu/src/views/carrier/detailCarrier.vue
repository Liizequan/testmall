<template>
    <div class="detail-order">
        ...
        <div class="between items-center order-top pbom20">
            ...
            <div>
                <el-button @click="detailUser">删除</el-button>
        ...
        <div class="basics ptop20 pbom20 border-bottom">
            ...
            <div class="basics-row">
                <el-row :gutter="20">
                    ...
                    <el-col :span="8">
                        <div class="basics-list">
                            <span>{{custom.typeId==1 ? '司机': '公司'}}名称：</span>
                            {{custom.username}}
                        </div>
                    </el-col>
                    <el-col :span="8" v-if="custom.typeId==2">
                        <div class="basics-list">
                            <span>联系人：</span>
                            {{custom.contact}}
                            <!-- 等待添加 -->
                    ...
                    <el-col :span="8">
                        <div class="basics-list">
                            <span>联系地址：</span>
                            {{custom.addresss +　custom.detail}}
                        </div>
                    </el-col>
                    <el-col :span="8" v-if="custom.typeId==1">
                        <div class="basics-list">
                            <span>车牌号码：</span>
                            {{custom.plate}}
                        </div>
        ...
        <div class="ptop40 auto-fujian border-bottom pbom40">
            ...
            <div class="flex ptop20" v-if="custom.typeId==2">
                <span>主营项目：</span>
                {{custom.service}}
            ...
            <div class="flex ptop20">
                ...
                <ul>
                    ...
                    <li v-for="(item,index) in custom.file" :key="index">
                        <span>{{item.fileId.name}}</span>
                        <el-link @click="lookFile(item)" :underline="false" title:="查看">查看</el-link>
                        <el-link :underline="false" :href='$http.noUrl+item.fileId.path' download="" title="下载">下载</el-link>
                    </li>
                </ul>
            </div>
        </div>
    ...
    methods: {
        ...
        detailUser(){
            this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                ...
                this.$http.post(this.$api.carrierDelete,{
                    id:this.$route.query.id
                },res=>{
                    console.log(res)
                    if(res.code==1){
