        ...
        <div class="ptop40">
            ...
            <div class="nav-bar">
                <el-tabs v-model="activeName" @tab-click="handleClick" style="padding-left:10px;" >
                    ...
                    <el-tab-pane label="个人散客" name="third"></el-tab-pane>
                </el-tabs>
                <div class="flex">
                    <!-- <el-button @click="goAdd">新建</el-button> -->
                    <import-export  :dataLength="(secled.length==0)" :isExport="true" :exportApi="this.$api.userExport+ '?exportId=' +daochuId">
            ...
            <!-- 数据列表 -->
             <el-table  :data="userList.data" stripe style="width: 100%" @selection-change="handleSelectionChange">
                ...
                <el-table-column  prop="name"  label="操作">
                    <template slot-scope="scope">
                        <p ><el-link :underline="false" @click="lookDetail(scope.row.id)">详情 <i class="el-icon-arrow-right"></i></el-link></p>
                    </template>
                </el-table-column>
            </el-table>
            <!-- 分页列表 -->
    ...
    methods: {
        ...
        handleClick(val){
            ...
            if(val.name == 'first'){
                ...
                this.api = this.$api.userGroup
            }else{//个人
                this.getUserList(this.$api.userMysel)
                this.api = this.$api.userMysel
            }
        },
        handleSizeChange(){
            console.log('wizhi')
        ...
        handleSizeChange(val){
            ...
            if(this.api == this.$api.userSearch){
