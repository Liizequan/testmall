        ...
        <div class="ptop40">
            ...
            <div class="nav-bar">
                <el-tabs v-model="activeName" @tab-click="handleClick" style="padding-left:10px;" >
                    ...
                    <el-tab-pane label="已取消" name="first"></el-tab-pane>
                ...
                <import-export :isExport="true" :importApi="this.$api.orderUpload" :exportApi="this.$api.orderExport + '?exportId=' +daochuId"/>
            </div>
            <!-- 数据列表 -->
            <div>
            <el-table  :data="orderData.data" stripe style="width: 100%" 
                ...
                <el-table-column  prop="date"  label="单号">
                    <template slot-scope="scope">
                        <p>业务订单：<el-link :underline="false"  class="order-num" @click="lookDetail(scope.row.id)">{{scope.row.numberOne}}</el-link></p>
                        <p>系统订单：<el-link :underline="false"  class="order-num" @click="lookDetail(scope.row.id)">{{scope.row.orderNo}}</el-link></p>
                ...
                <el-table-column  prop="name"  width="120" label="操作">
                    <template slot-scope="scope">
                        <div>
                            <div style="btn-list">
                                <p class="p-btn" v-if="scope.row.status > 5"><el-button style="width:100px;" @click="lookDetail(scope.row.id)">查看</el-button></p>
                                ...
                                <p class="p-btn" v-if="scope.row.status == 6">
                                    <el-button style="width:100px;" @click="handleClose(scope.row)">关闭订单</el-button>
                                </p>
                            </div>
                        </div>
                    </template>
