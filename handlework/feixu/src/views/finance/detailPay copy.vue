            ...
            <div class="basics-row">
                <el-row :gutter="20">
                    ...
                    <el-col :span="6">
                        <div class="basics-list">
                            <span>DN号：</span>
                            <p class="flex1">{{detailData.numberTwo}}</p>
                        </div>
                    </el-col>
                    <el-col :span="6">
                        <div class="basics-list">
            ...
            <div class="between">
                    ...
                    <div>
                        ...
                        <div class="ptop20">
                            <el-row :gutter="20" class="ptop20">
                                ...
                                <el-col :span="6">
                                    <div class="shipment-list">
                                        <span> 装卸费：</span>
                                        {{carrier.dockCost || 0}}元
                                    </div>
                                </el-col>
                                <el-col :span="6">
                                    <div class="shipment-list">
                                        <span> 保险费：</span>
                                        {{carrier.insurance || 0}}元
                                    </div>
                                </el-col>
                                <el-col :span="6">
                                    <div class="shipment-list">
                        ...
                        <div class="ptop40 items-center">
                            ...
                            <p class="items-center">总运费：
                                ...
                                已付<span>{{payAmount(carrier)}}</span>元，
                                油卡<span>{{payCard(carrier)}}</span>元，
                                还需要支付
                                <span>
                                    {{(parseFloat(carrier.cost) || 0 ) + (parseFloat(carrier.dockCost) || 0) + (parseFloat(carrier.insurance) || 0)
                ...
                <div class="shipment-right">
                    ...
                    <div class="btn between">
                        ...
                        <el-button @click="payment(carrier)" :disabled="carrier.approvalStatus==3">申请支付</el-button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="payment-content">
                    <div>
                        ...
                        <el-row class="table-list">
                            <el-col :span="4"><div class="" style="overflow-hidden;height:50px;">{{detailData.createTime}}</div></el-col>
                            <el-col :span="4"><div class="">{{detailData.project}}</div></el-col>
                            <el-col :span="6"><div class="">{{detailData.customer}}</div></el-col>
                            <el-col :span="10"><div class="">{{carrier.carry+' / '+ carrier.delivery}}</div></el-col>
                        </el-row>
                    </div>
                    <div class="ptop20">
                        <el-row class="back-title table-list">
                        ...
                        <div class="auto-list"  v-for="(items,indexs) in payLog" :key="indexs">
                            ...
                            <el-row class="is-row">
                                <el-col :span="8">
                                    <el-button style="width:150px;" :disabled="items.status>0" type="primary" @click="apply(items)">提交申请</el-button>
                                </el-col>
                            </el-row>
                        </div>
...
export default {
    ...
    methods: {
        ...
        apply(val){
            ...
            if(val.amount==0 && val.card){
                return this.$message('金额/油卡不能为0')
            }
            if(!val.card){
