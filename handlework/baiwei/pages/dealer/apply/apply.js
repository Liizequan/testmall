  ...
  formSubmit: function(e) {
    ...
    App._post_form('user.dealer.apply/submit', values, function() {
      ...
      _this.getApplyState();
        ...
        // 发起微信支付
        wx.requestPayment({
          timeStamp: result.data.data.payment.timeStamp,
          nonceStr: result.data.data.payment.nonceStr,
          package: 'prepay_id=' + result.data.data.payment.prepay_id,
          signType: 'MD5',
          paySign: result.data.data.payment.paySign,
